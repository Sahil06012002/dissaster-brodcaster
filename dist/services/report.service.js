...
exports.getReportsByDisasterId = exports.addReports = void 0;
const reportRepository = __importStar(require("../repository/report.repository"));
const addReports = async (reportData) => {
    const newReport = {
        ...reportData,
